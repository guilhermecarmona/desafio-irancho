<template>
  <section class="mb-4">   
    <div class="row">
      <h2 class="col-md-4 mb-3">Criar Pessoa</h2>
    ...
    <form class="container mt-3" @submit="checkForm" novalidate="true">    
      ...
      <button type="submit" class="mt-4 btn btn-primary" style="margin-left: -15px">Criar pessoa</button>        
    </form>    
  </section>
</template>
...
export default {
  ...
  methods: {
    ...
    criarPessoa(){
      return axios.post(`${config.urlRest}/pessoa`,{
          ...
          this.createToast('Pessoa criada','Pessoa criada com sucesso','success');
          setTimeout(() => {
            this.voltar();
          },2000);
        }).catch((e) => {
          console.log(e);
          this.createToast('Erro','Erro ao criar pessoa. Tente novamente mais tarde','danger');
        });
    },
