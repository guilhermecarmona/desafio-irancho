<template>
  <section class="mb-4">
    <div class="row">
      <h2 class="col-md-4 mb-3">Criar Animal</h2>
    ...
    <form class="container mt-3" @submit="checkForm" novalidate="true">    
      ...
      <button type="submit" class="mt-4 btn btn-primary" style="margin-left: -15px">Criar animal</button>
    </form>    
  </section>
</template>
...
export default {
  ...
  methods: {
    ...
    criarAnimal(){
      return axios.post(`${config.urlRest}/animal`,{
          ...
          this.createToast('Animal criado','Animal criado com sucesso','success');
          setTimeout(() => {
            this.voltar();
          },2000);
        }).catch((e) => {
          console.log(e);
          this.createToast('Erro','Erro ao criar animal. Tente novamente mais tarde','danger');
        });
    },
